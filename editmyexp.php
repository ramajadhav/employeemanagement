               ...
               <div class="row">
                ...
                <div class="col-4 mb-3">DA%</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp2name" name="emp2name" aria-describedby="emailHelp" value="<?php  echo $row['Employer2Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">DA Amount  </div>
                     <div class="col-8 mb-3">  <input type="text" class="form-control form-control-user" id="emp2des" name="emp2des" aria-describedby="emailHelp"></div>  
                      </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">HRA amount</div>
                     <div class="col-8 mb-3">
                ...
                <div class="col-4 mb-3">PF %</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp3name" name="emp3name" aria-describedby="emailHelp" value="<?php  echo $row['Employer3Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">PF Amount </div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Gross Salary </div>
                    <div class="col-8 mb-3">
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Net Pay</div>
                     <div class="col-8 mb-3">
...
<?php } ?>
  ...
  <script type="text/javascript">
   ...
   <script >
      function da()
      {
        // var sa=getElementsById("emp1ctc").value;
        // var d1=getElementsById("emp2name").value;
        // var cal;
        // var h=100;
        // cal=parseInt(3)/100*parseInt(15000);
        document.getElementsById("emp2des").value="karan";
      }
